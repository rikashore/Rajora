...
{
    public class PlayerJsonModel : BaseJsonModel
    {
        [JsonProperty("tag")]
        ...
        public LegendStatisticJsonModel LegendStatistics { get; set; }

        [JsonProperty("troops")]
        public PlayerItemJsonModel[] Troops { get; set; }

        [JsonProperty("heroes")]
        public PlayerItemJsonModel[] Heroes { get; set; }

        [JsonProperty("spells")]
        public PlayerItemJsonModel[] Spells { get; set; }
    }
}
